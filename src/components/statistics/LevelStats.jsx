...
export default function LevelStatsComp({ index, stats }) {
    ...
    const data01 = [
        { name: 'No. of employees with level 1 skills', value: levelList[1] },
        { name: 'No. of employees with level 2 skills', value: levelList[2] },
        { name: 'No. of employees with level 3 skills', value: levelList[3] },
        { name: 'No. of employees with level 4 skills', value: levelList[4] },
        { name: 'No. of employees with level 5 skills', value: levelList[5] },
    ];
    const data02 = [
        { name: 'No. of employees with level 1 skills', value: levelList[1] },
        { name: 'No. of employees with level 2 skills', value: levelList[2] },
