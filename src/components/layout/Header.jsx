...
import { Switch, useMantineTheme, rem, Group, Popover, Text, Modal, Button, Avatar, Tabs, Title, Badge, Drawer } from '@mantine/core';
import { useLocalStorage, useDisclosure } from '@mantine/hooks';
import { IconSun, IconMoonStars, IconBell, IconMessage2 } from '@tabler/icons-react';
...
export default function GenericHeader() {
    ...
    useEffect(() => {
        const socket = new WebSocket(`ws://api-team-finder.koyeb.app/ws/${auth.accessToken}`);
        
        socket.onopen = () => {
          console.log('WebSocket connected');
          // You can do something when the connection is established
        };
        ...
        socket.onclose = () => {
          ...
          // You can handle the close event here
        };
    ...
    return (
        <div className={`${darkMode && 'dark'}`} >
                ...
                <div className="dark:bg-darkcanvas bg-canvas select-none ">
                    ...
                    <div className="pl-6 pb-3 flex justify-between items-center">
                        ...
                        <Group justify="center" className='pr-4 pt-1'>
                            <Button className='hover:bg-transparent px-0' onClick={() => { open() }}>
            ...
            {isMobile && 
            <>
                <Modal opened={openedMenu} onClose={closeMenu} title="Authentication" fullScreen>
                    <p>blabla</p>
                </Modal>  
                <Button onClick={openMenu}>Open modal</Button>
            </>}
        </div >
    )
}